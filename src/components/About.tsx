...
const About = () => {
  ...
  return (
    <section id="about" className="section-padding bg-background/80 dark:bg-black relative overflow-hidden">
      {/* Shader background effects - only visible in dark mode */}
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-primary/30 rounded-xl flex items-center justify-center flex-shrink-0 backdrop-blur-sm">
          ...
          <div className="relative">
            <div className="aspect-video bg-gradient-to-br from-background/50 to-purple-900/30 dark:from-black/50 border border-primary/30 rounded-2xl p-8 shadow-2xl backdrop-blur-sm">
              <div className="w-full h-full bg-background/40 dark:bg-black/40 border border-primary/30 rounded-xl shadow-lg p-6 flex flex-col justify-center items-center backdrop-blur-sm">
