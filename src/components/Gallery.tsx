...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="section-padding relative overflow-hidden bg-background/80 dark:bg-transparent">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mb-20">
          ...
          <Tabs defaultValue="graphic-design" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-12 mt-[-16px] bg-card/80 dark:bg-black/50 backdrop-blur-sm p-1 rounded-2xl shadow-lg border border-border/50 dark:border-white/10">
              <TabsTrigger 
                value="graphic-design" 
                className="flex items-center gap-2 rounded-xl py-3 px-6 text-sm font-medium transition-all data-[state=active]:bg-blue-500 data-[state=active]:text-white text-muted-foreground"
              >
              ...
              <TabsTrigger 
                ...
                className="flex items-center gap-2 rounded-xl py-3 px-6 text-sm font-medium transition-all data-[state=active]:bg-purple-500 data-[state=active]:text-white text-muted-foreground"
              >
              ...
              <TabsTrigger 
                value="endorsement"
                className="flex items-center gap-2 rounded-xl py-3 px-6 text-sm font-medium transition-all data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-500 data-[state=active]:text-white text-muted-foreground"
              >
            ...
            <TabsContent value="graphic-design" className="mt-0">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {graphicDesignPortfolio.map((item, index) => (
                  <Card key={index} className="group overflow-hidden hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 hover:-translate-y-2 bg-card/80 dark:bg-black/50 border-border/50 dark:border-white/10 backdrop-blur-sm">
            ...
            <TabsContent value="content-creation" className="mt-0">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {contentCreationPortfolio.map((item, index) => (
                  <Card key={index} className="group overflow-hidden hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 hover:-translate-y-2 bg-card/80 dark:bg-black/50 border-border/50 dark:border-white/10 backdrop-blur-sm col-span-full">
                    <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {endorsementPortfolio.map((item, index) => (
                  <Card key={index} className="group overflow-hidden hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 hover:-translate-y-2 bg-card/80 dark:bg-black/50 border-border/50 dark:border-white/10 backdrop-blur-sm">
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-2">
                        <span className="text-xs font-medium text-pink-500 dark:text-pink-400 uppercase tracking-wide">
                          {item.category}
                        </span>
                        <h3 className="text-xl font-bold text-foreground">{item.title}</h3>
                        <p className="text-muted-foreground text-sm">{item.description}</p>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-6 hover:shadow-lg hover:shadow-purple-500/20 transition-shadow duration-300 bg-card/80 dark:bg-black/50 border-border/50 dark:border-white/10 backdrop-blur-sm">
