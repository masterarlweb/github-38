...
export function AnimatedAIChat() {
    ...
    return (
        <div className="min-h-screen flex flex-col w-full items-center justify-center bg-transparent text-foreground p-4 md:p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-2xl mx-auto relative">
                ...
                >
                    <div className="text-center space-y-3">
                        ...
                        >
                            <h1 className="text-2xl md:text-3xl font-medium tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/40 pb-1">
                        ...
                        >
                            Ketik perintah atau ajukan pertanyaan
                        </motion.p>
                    </div>
                    ...
                    >
                        ...
                        <div className="p-3 md:p-4 border-t border-border flex items-center justify-between gap-3 md:gap-4">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2">
                        {commandSuggestions.map((suggestion, index) => (
                            <motion.button
                                key={suggestion.prefix}
                                onClick={() => selectCommandSuggestion(index)}
                                className="flex items-center gap-2 px-3 py-2 bg-card/50 hover:bg-card rounded-lg text-xs md:text-sm text-muted-foreground hover:text-foreground transition-all relative group border border-border/50"
                                initial={{ opacity: 0, y: 10 }}
                                animate={{ opacity: 1, y: 0 }}
