...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative overflow-hidden min-h-screen bg-background text-foreground">
      {/* Twisted Gradient Background */}
      <div className="absolute inset-0 twisted-gradient"></div>
      
      {/* Dark overlay for better text readability */}
      <div className="absolute inset-0 bg-background/40"></div>

      <div className="container-custom relative z-10 pt-20 px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          {/* Text Content */}
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-8">
              <div className="inline-flex items-center px-6 py-3 bg-card/80 backdrop-blur-sm rounded-full border border-border shadow-lg">
                <div className="w-2 h-2 bg-primary rounded-full mr-3 animate-pulse"></div>
                <span className="text-sm font-medium text-foreground">🚀 First AI Digital Marketing Agency</span>
              </div>
              
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span className="text-foreground block mb-4">
                  Smooth gradients make
                </span>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Button 
                size="lg" 
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group text-lg"
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-border bg-card/50 text-foreground hover:bg-card hover:text-foreground font-semibold px-8 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group backdrop-blur-sm text-lg"
